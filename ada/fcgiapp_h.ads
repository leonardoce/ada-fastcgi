...
package fcgiapp_h is
   ...
   type FCGX_Stream;
   type FCGX_Stream_Access is access FCGX_Stream;
   ...
   type FCGX_Stream is record
      ...
      fillBuffProc : access procedure (arg1 : FCGX_Stream_Access);  -- c/fcgiapp.h:67
      emptyBuffProc : access procedure (arg1 : FCGX_Stream_Access; arg2 : int);  -- c/fcgiapp.h:68
   ...
   type FCGX_Request is record
      ...
      c_in : FCGX_Stream_Access;  -- c/fcgiapp.h:94
      c_out : FCGX_Stream_Access;  -- c/fcgiapp.h:95
      err : FCGX_Stream_Access;  -- c/fcgiapp.h:96
   ...
   function FCGX_StartFilterData (stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:313
   pragma Import (C, FCGX_StartFilterData, "FCGX_StartFilterData");

   procedure FCGX_SetExitStatus (status : int; stream : FCGX_Stream_Access);  -- c/fcgiapp.h:328
   ...
   function FCGX_GetChar (stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:369
   pragma Import (C, FCGX_GetChar, "FCGX_GetChar");

   function FCGX_UnGetChar (c : int; stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:385
   pragma Import (C, FCGX_UnGetChar, "FCGX_UnGetChar");

   function FCGX_GetStr
     (str : Interfaces.C.Strings.chars_ptr;
      n : int;
      stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:402
   pragma Import (C, FCGX_GetStr, "FCGX_GetStr");

   function FCGX_GetLine
     (str : Interfaces.C.Strings.chars_ptr;
      n : int;
      stream : FCGX_Stream_Access) return Interfaces.C.Strings.chars_ptr;  -- c/fcgiapp.h:421
   pragma Import (C, FCGX_GetLine, "FCGX_GetLine");

   function FCGX_HasSeenEOF (stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:442
   pragma Import (C, FCGX_HasSeenEOF, "FCGX_HasSeenEOF");

   function FCGX_PutChar (c : int; stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:462
   pragma Import (C, FCGX_PutChar, "FCGX_PutChar");

   function FCGX_PutStr
     (str : Interfaces.C.Strings.chars_ptr;
      n : int;
      stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:479
   pragma Import (C, FCGX_PutStr, "FCGX_PutStr");

   function FCGX_PutS (str : Interfaces.C.Strings.chars_ptr; stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:494
   pragma Import (C, FCGX_PutS, "FCGX_PutS");

   function FCGX_FPrintF (stream : FCGX_Stream_Access; format : Interfaces.C.Strings.chars_ptr  -- , ...
      ) return int;  -- c/fcgiapp.h:510
   pragma Import (C, FCGX_FPrintF, "FCGX_FPrintF");

   function FCGX_FFlush (stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:531
   pragma Import (C, FCGX_FFlush, "FCGX_FFlush");

   function FCGX_FClose (stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:557
   pragma Import (C, FCGX_FClose, "FCGX_FClose");

   function FCGX_GetError (stream : FCGX_Stream_Access) return int;  -- c/fcgiapp.h:569
   pragma Import (C, FCGX_GetError, "FCGX_GetError");

   procedure FCGX_ClearError (stream : FCGX_Stream_Access);  -- c/fcgiapp.h:580
   ...
   function FCGX_CreateWriter
     (socket : int;
      requestId : int;
      bufflen : int;
      streamType : int) return FCGX_Stream_Access;  -- c/fcgiapp.h:592
